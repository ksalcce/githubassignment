...
function displayWeather(data){
  debugger; 
  // if/else statement check if city not found.
  // if city not found display sorry cant find weather for store.location

  if(data.cod !== 200){
    $('#weather').html(`Sorry Cant find weather in ${store.location} !!`);
  }else{
